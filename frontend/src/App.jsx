...
import AsasRegister from './pages/AsasRegister';
...
function AppRoutes() {
  ...
  return (
    <Routes>
      <Route
        path="/"
        element={user ? <Navigate to={getHomeRouteForRole(user.role)} /> : <Navigate to="/login" />}
      />
      <Route path="/login" element={<Login />} />
      <Route path="/register" element={<Register />} />
      <Route path="/asas/register" element={<AsasRegister />} />
      <Route
        path="/dashboard"
        element={(
